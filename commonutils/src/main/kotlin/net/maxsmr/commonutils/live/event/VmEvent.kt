...
/**
 * Используйте в составе LiveData<VmEvent<T>> или StateFlow<VmEvent<T>> для оповещения View об одноразовых событиях из VM.
 ...
 *
 * Альтернативы:
 * 1. Если использовать без обертки VmEvent - View будет реагировать на него не 1 раз, а после
 * каждой смены конфигурации.
 * 2. Если использовать LiveSubject - то View получит эвент в том случае,
