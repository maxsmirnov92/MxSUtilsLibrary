...
public class LinearLayoutMaxSize extends LinearLayout {
    ...
    public LinearLayoutMaxSize(Context context) {
        this(context, null);
    }

    public LinearLayoutMaxSize(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LinearLayoutMaxSize(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initFromAttrs(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.LinearLayoutMaxSize, 0, 0);
            try {
                maxWidth = a.getDimensionPixelSize(R.styleable.LinearLayoutMaxSize_max_width, NOT_SET);
                maxHeight = a.getDimensionPixelSize(R.styleable.LinearLayoutMaxSize_max_height, NOT_SET);
            } finally {
                a.recycle();
            }
        }
